...
using WineryAssortment.Data;

namespace WineryAssortment.Controllers
{
    public class WinesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Price,Description,ImageUrl,DateModified,WineCattegoriesId,WineTypesId")] Wine wine)
        {
